...
module wiper_motor_common(outer_d = 35, solid_h = 4, shaft_d = inch_to_mm(0.255), which) {
    nut_d = 18;
    nut_h = 6;
...
module wiper_motor_cap(outer_d = 35, solid_h = 4) {
    wiper_motor_common(outer_d=outer_d, solid_h=solid_h, which=1);
}
