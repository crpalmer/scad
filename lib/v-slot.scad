...
module vslot_2020_extrusion(length = 20) {
    vslot_part("20x Extrusion", type="20mm", length=length);
}

module vslot_2040_extrusion(length = 20) {
    vslot_part("20x Extrusion", type="40mm", length=length);
}
